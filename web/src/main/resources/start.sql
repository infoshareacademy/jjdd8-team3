...
insert into vacation (reminder_email_sent, employee_id, from_date, vacation_status, to_date, vacation_type) values ('1', 2, '2020-01-27', 'APPLIED', '2020-02-27', 'PARENTAL');
insert into vacation (reminder_email_sent, employee_id, from_date, vacation_status, to_date, vacation_type) values ('1', 2, '2020-01-27', 'APPROVED', '2020-01-31', 'VACATION');
insert into vacation (reminder_email_sent, employee_id, from_date, vacation_status, to_date, vacation_type) values ('1', 2, '2020-05-27', 'APPLIED', '2020-06-07', 'PARENTAL');
